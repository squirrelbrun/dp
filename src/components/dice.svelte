<script lang="ts">
    ...
    $: cssIsShuffleingScale = opt.isShuffleing ? 0.8 : 1;
...
<button
    ...
    style="--withShuffle:{cssIsShuffleingScale}; --delay:-{opt.ordery}00ms"
    on:click={lockToggle}
...
<style>
    ...
    /* ordre de l'animation des dés pour que ce ne ca soit pas toute pareil quand on brasse! */
    .order-0{
